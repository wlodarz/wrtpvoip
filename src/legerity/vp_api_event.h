...
typedef enum {
    ...
    VP_LINE_EVID_OVR_CURNT_VOLT_FLT = 0x0080, /**< FXO Overcurrent/Overvoltage Fault */
...
typedef enum {
    VP_DEV_EVID_BOOT_CMP        = 0x0001, /**< VCP/VPP Startup sequence has
 ...
 *                In case of VCP, VPP class of devices, response mailbox is
