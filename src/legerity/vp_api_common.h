...
typedef enum
{
    ...
    VP_STATUS_MAILBOX_BUSY = 4,     /**< Function failed because VPP’s or VCP’s
    ...
    VP_STATUS_ERR_HBI = 11,         /**< An error occured due to mistmacth in
                                     ...
                                     * is being requested. */
    VP_STATUS_ERR_IMAGE = 12,       /**< Error in VCP/VPP image */
    ...
    VP_STATUS_INVALID_VOICE_STREAM = 16,/**< This error is generated when an invalid
...
/* Version and checksum information for VPP/VCP */
typedef struct
{
...
typedef enum
{
    ...
    VP_PROFILE_CAL,             /* Generic Calibration profile */
...
typedef struct {
    uint16 rloop;                   /**< The loop resistance */
...
typedef enum {
    ...
    VP_SENDSIG_MOMENTARY_LOOP_OPEN, /**< Applies Momentary Loop Open to FXO
                                     * Port and indicates if parallel phone
                                     * off-hook is present.
                                     */
    VP_SENDSIG_TIP_OPEN_PULSE,  /**< Set in 1mS increments */
